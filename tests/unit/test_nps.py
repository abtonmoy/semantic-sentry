...
from semantic_sentry.metrics.nps import nps, nps_per_point, nps_bounds
...
class TestNPS:
    ...
    def test_monotonic_with_perturbation(self):
        ...
        assert nps_small > nps_large, f"Small perturbation NPS ({nps_small}) should be > large ({nps_large})"
