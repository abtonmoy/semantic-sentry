...
from semantic_sentry import DriftMonitor, AnchorSet, Snapshot
...
class TestActualCheckpoints:
    ...
    def test_quantized_checkpoint_drift(self):
        ...
        snapshot_fp32 = monitor.snapshot(model_fp32, anchor_set, adapter=make_adapter(model_fp32))
        snapshot_quant = monitor.snapshot(model_quantized, anchor_set, adapter=make_adapter(model_quantized))
